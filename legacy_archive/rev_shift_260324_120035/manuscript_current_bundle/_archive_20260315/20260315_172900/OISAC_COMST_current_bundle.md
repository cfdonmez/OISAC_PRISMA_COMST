...
Primary inputs:
- analysis/VI_ev_v2/section6E_medium_slices.csv
- analysis/VI_ev_v2/s6f_dual_view_cmp.csv
...
- analysis/VI_ev_v2/section6E_summary_table.csv for network/overhead cues
Visual form:
