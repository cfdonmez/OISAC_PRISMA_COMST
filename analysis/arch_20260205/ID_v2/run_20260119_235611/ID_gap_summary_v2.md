...
|--------|-------|-----------|---------------------|
| G1 | Terminology harmonization | 1.00 | None |
| G2 | Metric normalization | 0.00 | None |
| G3 | Cross-modality benchmarking | 0.00 | None |
| G4 | Cross-domain transfer | 0.00 | None |
| G5 | Unified PHY framework/taxonomy | 1.00 | None |
| G6 | System-level co-design | 1.00 | None |
