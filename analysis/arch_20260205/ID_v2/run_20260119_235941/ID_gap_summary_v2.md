...
- Other: 10
- Optical comm survey: 5
- Multi-domain ISAC survey: 5
...
|--------|-------|-----------|---------------------|
| G1 | Terminology harmonization | 0.10 | None |
| G2 | Metric normalization | 0.15 | None |
| G3 | Cross-modality benchmarking | 0.05 | None |
| G4 | Cross-domain transfer | 0.00 | None |
| G5 | Unified PHY framework/taxonomy | 0.20 | None |
| G6 | System-level co-design | 0.70 | None |
| G7 | Systematic methodology | 0.00 | None |
