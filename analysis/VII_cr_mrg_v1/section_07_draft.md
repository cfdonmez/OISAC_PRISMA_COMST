...
Transition: Having completed the domain-specific verticals, VII-F synthesizes cross-domain coverage and transfer under the same evidence contract.
...
Transition: Building on this coverage-and-transfer synthesis, VII-G reconciles findings through the dual-view consistency accounting.
