...
MANIFEST_PATH = PROJECT_ROOT / "data/corp_man.json"
SOURCE_ROOT = PROJECT_ROOT / "data/proc_markdowns_comstPrev"
TARGET_ROOT = PROJECT_ROOT / "data/corp_std"
...
def standardize_corpus():
    ...
    for entry in tqdm(manifest):
        ...
        # Create Target Folder: data/corp_std/COMST_XXX/
