...
# CONFIG
PAPER_ID = "O_ISAC_029"
PDF_MARKDOWN_DIR = r"../../data/proc_markdowns"  # Relative path adjustment needed likely
SYSTEM_PROMPT_PATH = r"analysis/deep_res/config/system_prompt.md"
OUTPUT_DIR = r"analysis/deep_res/output"

def load_text(paper_id):
    # Try multiple base paths to accommodate different execution contexts (Colab root, module dir, etc.)
    base_paths = [
        "data/proc_markdowns",  # Run from project root (Notebook default)
        "../../data/proc_markdowns", # Run from analysis/deep_res/
        "/content/drive/MyDrive/AKU_WorkSpace/survey_fdgit/OISAC_PRISMA_COMST/data/proc_markdowns", # Colab Absolute
