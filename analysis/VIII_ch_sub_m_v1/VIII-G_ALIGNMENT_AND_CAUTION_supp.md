# VIII-G Alignment and Caution Supplement
...
- locator: `analysis/VIII_ev_v1/axis_definitions.md:L4`
  used_for: A-E remain the only challenge domains
...
- locator: `analysis/VIII_ev_v1/section8G_cross_section_report.md:L3`
  used_for: alignment-audit purpose
...
- example-availability finding used: example payload is absent across all current rows
