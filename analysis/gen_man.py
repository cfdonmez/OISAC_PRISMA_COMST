...
OUTPUT_MANIFEST = Path(r"c:\Users\fatih\gdrive\AKU_WorkSpace\survey_fdgit\OISAC_PRISMA_COMST\data\corp_man.json")
...
def generate_manifest():
    ...
    for idx, folder in enumerate(tqdm(subdirs)):
        ...
        entry = {
            ...
            "pdf_path_predicted": f"data/cprev/{folder.name}.pdf", # Prediction
            "status": "converted",
            "notes": ""
        }
