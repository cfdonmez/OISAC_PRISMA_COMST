...
# Import The Engine
import sys
# Ensure analysis/cot_lab is in path
sys.path.append(os.path.join(Config.PROJECT_PATH, "analysis/cot_lab"))
...
class ConfigV4(Config):
    OUTPUT_DIR = os.path.join(Config.PROJECT_PATH, "data/ext_res_v4")
    RECIPE_PATH = "analysis/cot_lab/recipes/experiment_v1_full_analysis.yaml"
...
def phase3_integrated_extraction(checkpoint: CheckpointManager, limit: int = None):
    ...
    for i, folder in enumerate(folders):
        ...
        try:
            ...
            recipe_rel_path = "analysis/cot_lab/recipes/experiment_v1_full_analysis.yaml"
