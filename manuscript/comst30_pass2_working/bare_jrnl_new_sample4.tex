...
The complete 220-study corpus is a systematic-review asset, but printing all 220 references in the main bibliography is not the best use of a COMST page budget. Pass 2 therefore removes `\texttt{\string\nocite\{*\}}' and cites representative, load-bearing studies in the main text. The full corpus remains traceable through the included-corpus ledger, extraction sheet, and supplementary evidence records. This separation protects systematic-review reproducibility while keeping the main bibliography focused on studies that directly support the narrative, taxonomy, enablers, applications, or governed metric synthesis.
...
% Additional application audit prose from the original draft remains in the supplement and is omitted from the Pass-2 main text.
...
% Additional internal roadmap audit scaffolding from the original draft remains in the supplement and is omitted from the Pass-2 main text.
