...
\\centering
\\resizebox{\\textwidth}{!}{%
\\begin{tabular}{|l|c|p{3.2cm}|p{3.2cm}|p{4cm}|p{4cm}|}
\\hline
...
\centering
\resizebox{\textwidth}{!}{%
\begin{tabular}{|l|c|p{3.4cm}|p{3.6cm}|p{3.6cm}|p{3.8cm}|}
\hline
...
\centering
\resizebox{\textwidth}{!}{%
\begin{tabular}{|l|p{4cm}|p{3.7cm}|p{4.2cm}|p{4cm}|}
\hline
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{figures/fig_iv_1.png}
...
\centering
\resizebox{\textwidth}{!}{%
\begin{tabular}{|l|p{3.5cm}|p{3.2cm}|p{3.6cm}|p{3.4cm}|p{3.2cm}|p{3.2cm}|p{3.4cm}|}
\hline
