...
\centering
\begin{tabular}{|c|p{7.4cm}|p{2.8cm}|}
\hline
...
\centering
\begin{tabular}{|p{2.5cm}|p{4.4cm}|p{4.0cm}|p{3.1cm}|}
\hline
Enabler family & Primary control role in O-ISAC & Strongest evidence posture in this review & Main deployment constraints \\
\hline
