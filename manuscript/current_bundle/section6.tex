...
\begin{tabularx}{\textwidth}{@{}L{2.4cm}Y L{2.2cm}@{}}
\toprule
\thead{Symbol} & \thead{Meaning} & \thead{Used in} \\
\midrule
...
\toprule
\thead{Item} & \thead{Minimum required fields} & \thead{Why it matters} \\
\midrule
