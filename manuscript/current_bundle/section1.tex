...
The escalating complexity of the electromagnetic environment has intensified demands for ultra-reliable wireless connectivity, driving significant interest in Integrated Sensing and Communication (ISAC) systems \cite{O_ISAC_070:1}. This integrated approach enables ultra-efficient spectrum utilization and significantly reduces hardware costs, and more importantly, establishes a foundational framework for achieving seamless connectivity in future wireless networks \cite{O_ISAC_070:2}. ISAC has now emerged as a core enabler in 6G networks and is recognized as one of the six key usage scenarios by both the ITU-R IMT-2030 framework \cite{O_ISAC_162:1} and 3GPP \cite{O_ISAC_162:2}, spanning the coexistence, cooperation, and co-design of communication and sensing functionalities \cite{O_ISAC_070:3}.
...
\hline
Ref. & Year & Tier & Modality Scope & Int. Depth & Methodology & Taxonomy & Metrics & Benchmark & Transfer & Enablers \\
\hline
\cite{O_ISAC_161} & 2025 & 2 & $\circ$ / $\circ$ / $\circ$ / $\circ$ & $\bullet$ & Review & $\oslash$ & -- & -- & -- & -- \\
\cite{O_ISAC_068} & 2023 & 2 & $\circ$ / $\circ$ / $\bullet$ / $\circ$ & $\bullet$ & Narrative & -- & -- & -- & -- & -- \\
\cite{O_ISAC_327} & 2024 & 2 & $\circ$ / $\circ$ / $\bullet$ / $\circ$ & $\oslash$ & Survey & $\oslash$ & -- & -- & -- & -- \\
\cite{O_ISAC_006} & 2024 & 2 & $\bullet$ / $\circ$ / $\circ$ / $\circ$ & $\oslash$ & Review & -- & $\oslash$ & -- & -- & -- \\
\cite{O_ISAC_368} & 2023 & 2 & $\bullet$ / $\circ$ / $\circ$ / $\circ$ & $\oslash$ & Review & -- & -- & -- & -- & -- \\
\cite{O_ISAC_021} & 2023 & 2 & $\circ$ / $\bullet$ / $\circ$ / $\circ$ & $\bullet$ & Tutorial & $\oslash$ & $\oslash$ & -- & -- & $\oslash$ \\
\cite{O_ISAC_070} & 2025 & 2 & $\circ$ / $\circ$ / $\circ$ / $\bullet$ & $\bullet$ & Narrative & $\oslash$ & -- & -- & -- & -- \\
\cite{O_ISAC_163} & 2025 & 2 & $\circ$ / $\circ$ / $\circ$ / $\circ$ & $\bullet$ & Survey & $\oslash$ & -- & -- & $\oslash$ & $\bullet$ \\
\cite{O_ISAC_303} & 2024 & 1 & $\circ$ / $\circ$ / $\bullet$ / $\circ$ & $\bullet$ & Review & $\oslash$ & $\oslash$ & -- & -- & -- \\
\textbf{This Review} & \textbf{2026} & \textbf{--} & \textbf{$\bullet$ / $\bullet$ / $\bullet$ / $\bullet$} & \textbf{$\bullet$} & \textbf{PRISMA 2020} & \textbf{$\bullet$} & \textbf{$\bullet$} & \textbf{$\bullet$} & \textbf{$\bullet$} & \textbf{$\bullet$} \\
\hline
\end{tabular}%
}
\end{table}
...
\centering
\begin{tabular}{|l|p{3.5cm}|p{4.5cm}|p{4cm}|}
\hline
