...
The publication window, language requirements, and search coverage described
in Section~\ref{sec:review_methods} define the literature represented by the
206 studies. Full texts were available and assessed for 272 of the 330 reports
sought, corresponding to 82.4\% retrieval coverage. Findings from unavailable
reports may therefore be absent from the synthesis. Selection involved
investigator judgment without routine independent duplicate review;
Electronic Supplement S-Protocol documents the review conduct.
