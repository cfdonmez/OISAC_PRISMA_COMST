...
We assessed all 206 included studies using the Technical Quality Assessment
Framework (TQAF) developed for this review. Its deterministic rules score
eight technical and reporting dimensions from 0 to 3, with overall evidence
contribution recorded separately. TQAF is a descriptive appraisal whose
scoring has not been independently validated; it does not provide a
conventional risk-of-bias assessment. Electronic Supplements S-Protocol and
S-Appraisal provide the scoring rules and study-level records, respectively.

Figure~\ref{fig:tqaf_profile} summarizes support for interpreting the reported
results and reusing them beyond their original setting. The analyses below
connect the validation, reproducibility, and benchmark-readiness dimensions
to tested settings, coverage of both functions, and reconstructability.
