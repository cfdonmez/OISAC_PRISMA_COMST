...
- Ek guncelleme:
  - kullanici geri bildirimi uzerine prompt'lar Section I figure estegine daha yakin olacak sekilde revize edildi
  - hedef artik yalnizca "dogru diagram" degil; daha panel-temelli, daha editorial, daha survey-flagship gorunumlu bir visual dildir

## Figure Review Snapshot (2026-03-15)

- Kullanici tarafinda uretilen Section VI assetleri `current_bundle/figures/` altina kaydedildi:
  - `fig_vi_1.jpg`
  - `fig_vi_2.jpg`
- Ayrintili review notu:
...
- Onemli operasyonel not:
  - Bu assetler henuz canonical `drafts/` altina kopyalanmadi
  - Bu nedenle `drafts/section_06_draft.md` icinde henuz formal image insertion yapilmadi
  - Integration sirasi: corrected asset -> `drafts/fig_vi_*.{png|jpg}` -> manuscript insertion -> bundle refresh

## Figure Integration Snapshot (2026-03-15)

- Daha sonraki ayni gun turunda Section VI figure integration bilerek bekletilmeden uygulandi.
- Canonical assetler:
  - `drafts/fig_vi_1.jpg`
  - `drafts/fig_vi_2.jpg`
- Gercek image insertion yapilan yerler:
  - `drafts/section_06_draft.md`
...
- Son durum:
  - `Fig. VI-1` ve `Fig. VI-2` artik manuscript icinde aktif
  - kalan isler placement degil, yalnizca ileride istenirse polish/revision seviyesindedir
