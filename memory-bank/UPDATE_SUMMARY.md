...
- Section II repo-ici olarak yeniden netlestirildi:
  ...
  - results / prevalence section degil
- Kilit support rolleri kayda gecirildi:
  - `Fig. II-1` = unified O-ISAC system abstraction
  - `Table II-1` = modality-aware channel / transceiver abstraction summary
  - `Table II-2` = metric contract / comparability guard summary
  - `Fig. II-2` = admissible vs forbidden metric-comparison map
- Guncel hukum degismedi:
  - `Fig. II-1` near-final / optional polish
  - `Fig. II-2` teknik relation cleanup acik
- Bu oturum repo-ici clarification / handoff turu olarak kapatildi; manuscript, bundle, veya image asset katmaninda yeni degisiklik yapilmadi.
