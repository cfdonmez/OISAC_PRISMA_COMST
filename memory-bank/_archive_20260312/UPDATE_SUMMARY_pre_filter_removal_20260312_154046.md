...
- Bu guncelleme sonrasi Section VI kalan durum esas olarak analysis-pipeline hijyeni seviyesine indi:
  - invalid OPA/RIS metric filtering
  - readiness rerun (yalnizca pipeline tekrar kullanilacaksa)
