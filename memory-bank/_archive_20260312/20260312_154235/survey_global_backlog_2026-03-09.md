...
## Status snapshot
- Section VI: authoritative recovery merge applied; `drafts/section_06_draft.md` now mirrors `drafts/draft6_FD.md`, and the remaining work is post-recovery quality hardening.
...
1. Section VI post-recovery quality hardening
...
5. Full manuscript integration and final QA (release gate)
6. Section III archival upstream evidence recovery (valuable but non-blocking)

## Open tasks by section

### Section VI (post-recovery hardening + consistency gate)
...
- Simdi re-apply edilmesi gereken quality gates:
