...
- Son durum:
  - figure conceptually usable / near-final
  - duplicated output box sorunu artik kapali
  - kalan is visual polish seviyesinde
- Kayda gecen polish sirası:
  - `Joint design` box active gorunmeli
  - shared output box daha kompakt olmali
  - output label layout toparlanmali
  - right-side integration panel hafif geri cekilmeli
  - title biraz kucultulmeli
- Repo placement notu:
