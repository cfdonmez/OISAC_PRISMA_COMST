...
- Section VII: survey-alignment ve reporting-policy lock tamamlandi; kalan is final terminology/handoff consistency.

## Priority order (global)
1. Section IV / VII cross-section consistency hardening (cross-section gate)
2. Full manuscript integration and final QA (release gate)
