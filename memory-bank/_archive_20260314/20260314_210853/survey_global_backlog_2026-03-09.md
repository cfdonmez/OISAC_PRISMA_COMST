...
1. Final figure package and placement
   ...
   - then write Section II `Fig. II-1 / Fig. II-2` specs under the locked COMST visual strategy
...
- Figure-package gate icin mevcut karar ihtiyaci:
  ...
  - Section II `Fig. II-1 / Fig. II-2` spec'lerinin COMST explanatory/governance rolune gore yazilmasi
