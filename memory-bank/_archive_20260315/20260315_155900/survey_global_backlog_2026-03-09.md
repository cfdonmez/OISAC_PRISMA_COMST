...
- Review-package QA verdict is `CONDITIONAL PASS`; acik release kalemleri final user-owned Section VI figure placement, Section IV visual/table/equation package, ve gerekirse Section IX source kararidir.
...
1. Final figure package and placement
  ...
  - aktif onceklik artik Section IV visual / table / equation package
2. Section VI user-owned figure placement + final figure polish items
...
### Section IV (post-polish integration check + future visual package)
...
- Kullanici hatirlatmasi: Section IV atlanmayacak; bu bolum icin grafik / tablo / denklem paketi sonraki aktif tasarim islerinden biri olarak ele alinacak.
