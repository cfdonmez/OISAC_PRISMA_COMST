...
4) Figure / table / equation package should not be skipped
- Kullanici hatirlatmasi dogrultusunda Section IV halen aktif future-package adayidir:
  - grafikler
  - tablolar
  - denklemler
- Etki: Section IV yalnizca prose-polish ile kapatilmis sayilmayacak; final manuskriptte bu bolume ait gorsel ve matematiksel destek katmani bilincli olarak planlanacak.
...
5. Figure / table / equation package'i ayri bir mini-pass olarak planla
- `Fig. IV-*`, `Table IV-*`, ve gerekli governance / taxonomy denklemleri ayni section-rol mantigiyla toparlanacak.
- Section IV bu anlamda "atlandi" kabul edilmeyecek; sonraki aktif manuskript fazinda geri acilacak.
