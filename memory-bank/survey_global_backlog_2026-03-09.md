# Survey Global Backlog (updated 2026-03-18)

Owner: AI + User  
Scope: Whole-manuscript next steps after Section III freeze lock, Section V re-entry, and Section VI recovery merge.

## Status snapshot
- 2026-03-18 Section II role-clarification sync:
  - Section II yeniden "results section" degil, explanatory/governance package olarak teyit edildi
  - support rolleri kilitlendi:
    - `Fig. II-1` = unified system abstraction
    - `Table II-1` = modality/channel/transceiver scaffold
    - `Table II-2` = metric contract ledger
    - `Fig. II-2` = comparison-governance map
  - Section II acik teknik kalemi degismedi:
    - `fig_ii_2` semantic cleanup
    - `fig_ii_1` yalnizca optional polish
...
- Section VIII: local visual/text cleanup ve final closeout audit haricinde figure package acigi kalmadi.
...
- Bundan sonraki aktif yerel is:
  - `Fig. VIII-1` visual/text cleanup
  - final Section VIII closeout audit
