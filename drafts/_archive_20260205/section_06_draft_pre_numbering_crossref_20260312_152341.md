...
| Photonic generation / photonic-THz bridge | Source and distribution pathway for hybrid optical-wireless control chains | Bridge evidence only; relevant for hybrid system interpretation but not a standalone maturity claim in VI-A | Stage-aware modeling, cross-plane reporting, front-end chain complexity | Connects enabler discussion to hybrid and transfer-oriented system views |
