...
## � Çıktı Dosyaları
- **JSON Sonuçları**: `data/extraction_results_v4/`
- **Birleştirilmiş Özet**: `data/extraction_results_v4/extraction_v4_summary.csv`
- **Kontrol Listesi**: `data/extraction_results_v4/checkpoint_v4.json`
