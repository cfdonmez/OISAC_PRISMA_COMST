...
| Temperature interval | $M_f R_s$ interferometer | $\mathbb{R}^2$ | $M_sR_f$ interferometer | $\mathbb{R}^2$ |
|----------------------|--------------------------|----------------|-------------------------|----------------|
| (°C)                 | (rad/°C)                 |                | (rad/°C)                |                |
