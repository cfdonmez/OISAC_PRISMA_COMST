...
Maoqi Liu<sup>®</sup>, Jingchuan Wang<sup>®</sup>, Chen Liu<sup>®</sup>, *Senior Member, IEEE*, Changyuan Yu<sup>®</sup>, *Fellow, OSA*, and Chao Lu<sup>®</sup>, *Fellow, OSA* 
...
$$r_f(t) = S_{\text{lfm}}(t) \otimes r(t) = [S_{\text{lfm}}(t) \otimes S_{\text{lfm}}(t)] * h(t), \quad (14)$$
