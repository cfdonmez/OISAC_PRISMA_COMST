# COMST_review_bundle_02_rules_methodology.md

## review_package/surv_write_guide.md
...
## review_package/prisma_proto.md
...
## review_package/II_metric_governance.md
...
- Measurement-plane mapping must be explicit in Section II-A: OSNR is optical (pre-detection) and electrical SNR is post-detection; generic SNR without plane context is non-comparable.
...
## review_package/II_schema_map.md
