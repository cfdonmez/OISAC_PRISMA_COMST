...
Source: `analysis/synthesis_report.md`, `analysis/writing_blueprints_master.json`, `analysis/layout_stats.json`, `analysis/rhetoric_report.json`, and section templates in `memory-bank/`. Built from 76 IEEE COMST survey papers.
...
Use this recipe with the section templates (`memory-bank/`) and phrasebank (`analysis/phrasebank.json`) to turn the 76-paper reverse-engineering into a single-pass writing workflow.
