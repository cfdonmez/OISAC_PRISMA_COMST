...
> **Aligned With:** PRISMA 2020, prisma_proto.md (Section 4, 8, 9)
...
- `prisma_proto.md` → WHAT to extract (eligibility, data items)
...
> Full details: `protocol/prisma_proto.md` Section 4
...
| Output | Location |
|--------|----------|
| Extraction JSON | `data/test_out/O_ISAC_XXX_simulation.json` |
| Tracking Table | `data/ext_track.md` |
| Schema | `analysis/oisac_ext_sch_v2.yaml` |
...
| Document | Purpose |
|----------|---------|
| [prisma_proto.md](../protocol/prisma_proto.md) | Full PRISMA protocol |
| [schema_v2.yaml](../analysis/oisac_ext_sch_v2.yaml) | Field definitions |
| [v4_pipe_expl.md](v4_pipe_expl.md) | Automated pipeline |
| [ph3_cot_eng.md](ph3_cot_eng.md) | CoT reasoning details |
| [ext_track.md](../data/ext_track.md) | Progress tracking |
